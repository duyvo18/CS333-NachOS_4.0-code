...
#define SC_PrintString 52
#define SC_RandomNum 53
#define SC_ReadNum 54
#define SC_ReadChar 55
#define SC_ReadString 56
...
/*
 * Read and return an integer from console input
 */
int ReadNum();

/*
 * Read and return a character from console input
 */
int ReadChar();

/*
 * Read and return a string from console input
 */
